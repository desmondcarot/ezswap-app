...
only appear inside <code>async</code> functions. Defaults to <code>true</code> for
<code>ecmaVersion</code> 2022 and later, <code>false</code> for lower versions. Setting this option to
